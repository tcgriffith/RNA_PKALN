...
rng_seq=function(pairs=NULL,len=30){
  ...
  myseq[6:7]=sample(c("a","u","c","g","."),2,replace = TRUE, prob=c(1,1,1,1,3))
  myseq[13:14]=sample(c("a","u","c","g","."),2,replace = TRUE, prob=c(1,1,1,1,3))  
...
dir.create(here::here("data/synth6/"),recursive=TRUE)

seqtmp[[1]]

seqinr::write.fasta(seqtmp,names=seqnames,file.out=here::here("data/synth6/seq1000_gaps.a2m"))

wd=here::here("data/synth6")
