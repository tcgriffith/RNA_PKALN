...
rng_seq=function(pairs=NULL,len=30){
  ...
  myseq[18:22]="-"
  myseq[18:22]=sample(c("a","u","c","g","."),5,replace = TRUE, prob=c(1,1,1,1,3))
...
dir.create(here::here("data/synth2/"),recursive=TRUE)

seqtmp[[1]]

seqinr::write.fasta(seqtmp,names=seqnames,file.out=here::here("data/synth2/seq1000_gaps.a2m"))
```


```{r}
wd=here::here("data/synth2")
...
cp seq1000_gaps.sto synth2.sto
