...
dir.create(here::here("data/synth3/"),recursive=TRUE)

seqtmp[[1]]

seqinr::write.fasta(seqtmp,names=seqnames,file.out=here::here("data/synth3/seq1000_gaps.a2m"))
```


```{r}
wd=here::here("data/synth3")
