...
rng_seq=function(pairs=NULL,len=30){
  ...
  myseq[7:10]=sample(c("a","u","c","g","."),4,replace = TRUE, prob=c(1,1,1,1,3))
  myseq[33:36]=sample(c("a","u","c","g","."),4,replace = TRUE, prob=c(1,1,1,1,3))  
    # myseq[23:24]=sample(c("a","u","c","g","."),2,replace = TRUE, prob=c(1,1,1,1,3))  
...
seqtmp=lapply(1:300,function(i){
 return(rng_seq(pairs=pairs,len=50)) 
})

seqnames=paste0("seq",1:300)

dir.create(here::here("data/synth10/"),recursive=TRUE)

seqtmp[[1]]

seqinr::write.fasta(seqtmp,names=seqnames,file.out=here::here("data/synth10/seq1000_gaps.a2m"))

wd=here::here("data/synth10")
