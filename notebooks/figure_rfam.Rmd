...
data.filt = mytable.wide %>%
  filter(PK_rnamrf - PK_cmalign > 0.25)
...
```{r fig.height=9}
rfam_patch2=gg2+gg_pk2+gg1+gg_cont_sens+plot_layout(guides="collect",byrow = FALSE) +plot_annotation(tag_levels = "A")& theme_classic() & theme(axis.text.x=element_text(angle=45,hjust = 1))
